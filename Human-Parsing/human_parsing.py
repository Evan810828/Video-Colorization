...
import networks
from utils.transforms import BGR2RGB_transform, transform_parsing, transform_logits
from utils.global_local_datasets import CropDataValSet
...
def get_arguments():
    ...
    parser.add_argument("--model-restore", type=str, default='pretrain_model/exp_schp_multi_cihp_local.pth')
